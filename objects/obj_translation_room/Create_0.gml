...
switch global.next_level{
	...
	case 4:	room_to_go = rm_level_4; break;
	case 5:	room_to_go = rm_level_5; break;
}

var _larg = sprite_get_width(spr_square)
col = ceil((room_width/3) / _larg)
lin = ceil(room_height / _larg)
...
var _spawn_block = function(){
	...
	instance_create_layer(_x*_larg + _larg_half + (room_width/3),_y*_larg + _larg_half,"Translation",obj_square)
	instance_create_layer(_x*_larg + _larg_half + (room_width/3)*2,_y*_larg + _larg_half,"Translation",obj_square)
	instance_create_layer(_x*_larg + _larg_half,(_y*_larg + _larg_half + (room_height/3)*5),"Translation",obj_square)
...
var _aviso = function(){
	...
	if global.return_menu{room_goto(rm_start)}
	else{room_goto(room_to_go)}
}

var _timer_1 = time_source_create(time_source_game,126,time_source_units_frames, _aviso)
