...
player_control = function(){
	...
	if lost_control{_floor = 0;_tramp = 0;_jump = 0;_left = 0;_right = 0}
	...
	if flag_state_fall {state = state_fall}
	if start_trampoline {state = state_jump_trampoline; start_trampoline = false}
}
...
state_animation_1 = function(){
	lost_control = true
	state_txt = "animation_1"
	player_control()
	change_sprite(0)
	
	if flag_aux_1 <= 0{flag_aux_1 = 1;alarm[2] = 120}
}
state_animation_2 = function(){
	lost_control = true
	state_txt = "animation_2"
	player_control()
	change_sprite(0)
	
}
state_animation_3 = function(){
	lost_control = true
	state_txt = "animation_3"
	player_control()
	change_sprite(1)
...
state = state_idle
if n_player == 2{state = state_animation_2}