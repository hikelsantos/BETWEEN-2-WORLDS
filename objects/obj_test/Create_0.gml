...
draw_text_ani_w_shadow = function(_text){
	...
	_x1 = 180 + display_get_gui_width()/2 + (32*sin(1.7*_temp)) //(XX*sin(YY*_temp)) --> XX- Aumenta Amplitude // YY- Aumenta Velocidade/Frequência
	_y1 = 380 + (6*sin(1.2*_temp))
	_ang = 0 - (5*sin(1.2*_temp))
	...
	_temp += .1
	_x1 = 180 + display_get_gui_width()/2 + (32*sin(1.7*_temp))
	_y1 = 380 + (6*sin(1.2*_temp)) 
	_ang = 0 - (5*sin(1.2*_temp))
